...
var SliceProgram = /** @class */ (function () {
    function SliceProgram(destSize) {
        ...
        var sourceCoords = getCoords$2(this.rank);
        var body;
...
var CumProdProgram = /** @class */ (function () {
    function CumProdProgram(shape, exclusive, reverse) {
        this.variableNames = ['x'];
...
function cumprod(args) {
    ...
    if (exclusive) {
        var program = new CumProdProgram(permutedX.shape, exclusive, reverse);
        var prevResult = result;
