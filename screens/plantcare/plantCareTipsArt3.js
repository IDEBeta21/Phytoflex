        ...
        <View>
            <ScrollView
                ...
                <View style={styles.content}>
                    ...
                    <PFText weight='semi-bold' style={styles.section}>Garlic spray – fungal disease</PFText>
                    {'\n'} 
                    Boil 5ml of crushed garlic in one litre of water for five minutes; strain and leave to cool.
                    {'\n'} {'\n'}

                    <PFText weight='semi-bold' style={styles.section}>Nasturtium spray – aphids, scale and red spider mite</PFText>
                    {'\n'} 
                    ...
                    <PFText weight='semi-bold' style={styles.section}>Quassia spray – a general insect poison</PFText>
                    {'\n'} 
                    ...
                    <PFText weight='semi-bold' style={styles.section}>Soap spray – aphids and mealy bugs</PFText>
                    {'\n'} 
                    ...
                    <PFText weight='semi-bold' style={styles.section}>Soya bean spray – black spot and powdery mildew</PFText>
                    {'\n'} 
                    ...
                    <PFText weight='semi-bold' style={styles.section}>Wormwood or Tansy spray – cutworm, bollworm and fruit fly</PFText>
                    {'\n'} 
